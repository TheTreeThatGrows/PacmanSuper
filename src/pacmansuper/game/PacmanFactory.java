...
public class PacmanFactory implements EntityFactory {
    ...
    @Spawns("door_level_1")
    public Entity newDoor_Level_1(SpawnData data) {
        return Entities.builder()
                .type(GameType.DOOR_LEVEL_1)
                .from(data)
                .bbox(new HitBox(BoundingShape.box(data.<Integer>get("width"), data.<Integer>get("height"))))
                .with(new CollidableComponent(true))
                .build();
    ...
    @Spawns("door_level_4")
    public Entity newDoor_Level_4(SpawnData data) {
        return Entities.builder()
                .type(GameType.DOOR_LEVEL_4)
                .from(data)
                .bbox(new HitBox(BoundingShape.box(data.<Integer>get("width"), data.<Integer>get("height"))))
                .with(new CollidableComponent(true))
                .build();
    ...
    @Spawns("door_level_2")
    public Entity newDoor_Level_2(SpawnData data) {
        return Entities.builder()
                .type(GameType.DOOR_LEVEL_2)
                .from(data)
                .bbox(new HitBox(BoundingShape.box(data.<Integer>get("width"), data.<Integer>get("height"))))
                .with(new CollidableComponent(true))
                .build();
    ...
    @Spawns("door_level_3")
    public Entity newDoor_Level_3(SpawnData data) {
        return Entities.builder()
                .type(GameType.DOOR_LEVEL_3)
                .from(data)
                .bbox(new HitBox(BoundingShape.box(data.<Integer>get("width"), data.<Integer>get("height"))))
                .with(new CollidableComponent(true))
                .build();
    ...
    @Spawns("levelcomplete_1x3")
    public Entity newLevelComplete_1x3(SpawnData data) {
        return Entities.builder()
                .type(GameType.LEVELCOMPLETE_1x3)
                .from(data)
                .bbox(new HitBox(BoundingShape.box(data.<Integer>get("width"), data.<Integer>get("height"))))
                .with(new CollidableComponent(true))
                .build();
    ...
    // ------------------------------------- <<< LEVEL: 7 >>> -------------------------------------
    @Spawns("door_level_8")
    public Entity newDoor_Level_8(SpawnData data) {
        return Entities.builder()
                .type(GameType.DOOR_LEVEL_8)
                .from(data)
                .bbox(new HitBox(BoundingShape.box(data.<Integer>get("width"), data.<Integer>get("height"))))
                .with(new CollidableComponent(true))
                .build();
    ...
    // ------------------------------------- <<< LEVEL: 8 >>> -------------------------------------
    @Spawns("door_level_9")
    public Entity newDoor_Level_9(SpawnData data) {
        return Entities.builder()
                .type(GameType.DOOR_LEVEL_9)
                .from(data)
                .bbox(new HitBox(BoundingShape.box(data.<Integer>get("width"), data.<Integer>get("height"))))
                .with(new CollidableComponent(true))
                .build();
    ...
    // ------------------------------------- <<< LEVEL: 9 >>> -------------------------------------
    @Spawns("levelcomplete_7x9")
    public Entity newLevelComplete_7x9(SpawnData data) {
        return Entities.builder()
                .type(GameType.LEVELCOMPLETE_7x9)
                .from(data)
                .bbox(new HitBox(BoundingShape.box(data.<Integer>get("width"), data.<Integer>get("height"))))
                .with(new CollidableComponent(true))
                .build();
    ...
    @Spawns("door_level_15")
    public Entity newDoor_Level_15(SpawnData data) {
        return Entities.builder()
                .type(GameType.DOOR_LEVEL_15)
                .from(data)
                .bbox(new HitBox(BoundingShape.box(data.<Integer>get("width"), data.<Integer>get("height"))))
                .with(new CollidableComponent(true))
                .build();
    ...
    @Spawns("door_level_16")
    public Entity newDoor_Level_16(SpawnData data) {
        return Entities.builder()
                .type(GameType.DOOR_LEVEL_16)
                .from(data)
                .bbox(new HitBox(BoundingShape.box(data.<Integer>get("width"), data.<Integer>get("height"))))
                .with(new CollidableComponent(true))
                .build();
    ...
    @Spawns("levelcomplete_14x16")
    public Entity newLevelComplete_14x16(SpawnData data) {
        return Entities.builder()
                .type(GameType.LEVELCOMPLETE_14x16)
                .from(data)
                .bbox(new HitBox(BoundingShape.box(data.<Integer>get("width"), data.<Integer>get("height"))))
                .with(new CollidableComponent(true))
                .build();
